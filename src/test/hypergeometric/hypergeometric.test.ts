...
import {hypergeometric} from "../../index";
import {digitsOfAgreement} from "../digitCompare";
const testCases = require("../../../test_cases/hypergeometric/testCases_data2");



should();

const DIGIT_AGREE_TOLERANCE_PDF = 14;
const DIGIT_AGREE_TOLERANCE_CDF_LOWER = 14;
const DIGIT_AGREE_TOLERANCE_CDF_UPPER = 13;
      ...
      describe("accuracy tests", function() {
        describe("boost data set", function() {
          ...
          it("should match high accuracy estimates of function values", function () {
            let testValue = hypergeometric.pdf(
              testCase["sampleSuccesses"],
              testCase["draws"],
              testCase["successPop"],
              testCase["totalPop"]
            );
            ...
            let doa = digitsOfAgreement(testCase["pdf"], testValue);
      ...
      describe("accuracy tests", function() {
        describe("boost data set", function() {
          ...
          it("should match high accuracy estimates of function values - lower", function () {
            let testValue = hypergeometric.cdf(
              testCase["sampleSuccesses"],
              testCase["draws"],
              testCase["successPop"],
              testCase["totalPop"],
            ...
            let doa = digitsOfAgreement(testCase["cdfLower"], testValue);
          ...
          it("should match high accuracy estimates of function values - upper", function () {
            ...
            let doa = digitsOfAgreement(testCase["cdfUpper"], testValue);
    ...
    describe("quantile", function() {
      describe("accuracy tests", function() {
        describe("boost data set", function() {
          ...
          it("should match high accuracy estimates of function values - lower", function () {
            let testValue = hypergeometric.quantile(
              testCase["cdfLower"],
              testCase["draws"],
              testCase["successPop"],
              testCase["totalPop"],
            ...
            if (testCase["cdfLower"] === 1) {
              ...
              testValue.should.equal(Math.max(
                0,
                testCase["draws"] + testCase["successPop"] - testCase["totalPop"]
              ));
            } else if (testCase["cdfLower"] > 1 - 1e-14) {
              testValue.should.be.within(
                testCase["sampleSuccesses"] - 1,
                testCase["sampleSuccesses"] + 1
              );
            } else {
