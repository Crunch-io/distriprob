...
const testCasesQuantile = require("../../../test_cases/binomial/testCases_dist_quantile");



should();

const DIGIT_AGREE_TOLERANCE = 16;
  ...
  describe("quantile", function() {
    describe("accuracy tests", function() {
      describe("boost data set", function() {
        for (let testCase of testCasesQuantile) {
          it("should match high accuracy estimates of function values - lower", function () {
            let testValue = binomial.quantile(
              testCase["p"],
              testCase["trials"],
              testCase["probSuccess"],
              true
            );
