...
export class BesselJ1 {

  public static bessel_j1(x: number): number {
    const P1: number[] = [
    ...
    const x1  =  3.8317059702075123156e+00;
    const x2  =  7.0155866698156187535e+00;
    const x11 =  9.810e+02;
    const x12 =  -3.2527979248768438556e-04;
    const x21 =  1.7960e+03;
    const x22 =  -3.8330184381246462950e-05;

    let value, factor, r, rc, rs, w;
