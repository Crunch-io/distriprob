 ...
 *
 */
var Primes = /** @class */ (function () {
    function Primes(maxLimit) {
        this._primeNumbers = Primes.lessThanOrEqualTo(maxLimit);
        this._maxLimit = maxLimit;
    }
    Object.defineProperty(Primes.prototype, "maxLimit", {
        get: function () {
    ...
    Primes.prototype.value = function (n) {
        if (n >= this._primeNumbers.length) {
            throw new Error("Out of bounds error");
        }
        return this._primeNumbers[n];
    };
    Primes.lessThanOrEqualTo = function (n) {
        if (n === 0) {
            return [];
        }
        else if (n === 1) {
