...
var Erf = /** @class */ (function () {
    function Erf() {
    }
    Erf.erf_asympt_series_t_generator = function (z) {
        var result, xx, tk, r;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    result = (-Math.exp(-z * z) / Constants.SQRTPI()) / z;
                    xx = 2 * -z * z;
                    tk = 1;
                    _a.label = 1;
                case 1:
    ...
    Erf.erf_asymptotic_limit_N = function () { return 4.3; };
    // this is the Boost 53-bit mantissa precision implementation
    Erf.erf_imp = function (z, invert) {
        if (z < 0) {
            if (!invert) {
        ...
        if (z < 0.5) {
            ...
            if (z < 1e-10) {
                if (z === 0) {
                    ...
                    var c = 0.003379167095512573896158903121545171688;
                    result = z * 1.125 + z * c;
                }
            }
            else {
