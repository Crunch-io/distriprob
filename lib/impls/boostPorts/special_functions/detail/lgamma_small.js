...
var LGammaSmall = /** @class */ (function () {
    function LGammaSmall() {
    }
    LGammaSmall.lgamma_small_imp = function (z, zm1, zm2) {
        ...
        if (z < Precision.epsilon()) {
            ...
            var Y = 0.158963680267333984375;
            var r = zm2 * (z + 1);
            var R = Rational.evaluate_polynomial(P, zm2);
            ...
            if (z <= 1.5) {
                ...
                var r = Rational.evaluate_polynomial(P, zm1) /
...
exports.LGammaSmall = LGammaSmall;
