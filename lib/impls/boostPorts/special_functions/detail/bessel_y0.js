...
var BesselY0 = /** @class */ (function () {
    function BesselY0() {
    }
    BesselY0.bessel_y0 = function (x) {
        var P1 = [
        ...
        if (x < 0) {
            throw new Error("Domain error: Got x = " + x + " but x must be non-negative," + "" + " complex result not supported.");
        }
        if (x === 0) {
        ...
        if (x <= 3) {
            var y = x * x;
            var z = 2 * Math.log(x / x1) * BesselJ0.bessel_j0(x) / Math.PI;
            ...
            var y = x * x;
            var z = 2 * Math.log(x / x2) * BesselJ0.bessel_j0(x) / Math.PI;
            ...
            var y = x * x;
            var z = 2 * Math.log(x / x3) * BesselJ0.bessel_j0(x) / Math.PI;
