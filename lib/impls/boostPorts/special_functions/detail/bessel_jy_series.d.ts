export declare class BesselJYSeries {
    private static bessel_j_small_z_series_term(v, x);
    /**
     ...
     */
    static bessel_j_small_z_series(v: number, x: number): number;
    private static bessel_y_small_z_series_term_a(v, x);
    private static bessel_y_small_z_series_term_b(v, x);
    /**
     ...
     */
    static bessel_y_small_z_series(v: number, x: number): {
        result: number;
        pscale: number;
    };
    static bessel_yn_small_z(n: number, z: number, scale: number): {
        result: number;
        scale: number;
    };
}
