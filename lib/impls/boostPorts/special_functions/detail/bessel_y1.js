...
var BesselY1 = /** @class */ (function () {
    function BesselY1() {
    }
    BesselY1.bessel_y1 = function (x) {
        var P1 = [
        ...
        if (x <= 4) {
            var y = x * x;
            var z = 2 * Math.log(x / x1) * BesselJ1.bessel_j1(x) / Math.PI;
            ...
            var y = x * x;
            var z = 2 * Math.log(x / x2) * BesselJ1.bessel_j1(x) / Math.PI;
