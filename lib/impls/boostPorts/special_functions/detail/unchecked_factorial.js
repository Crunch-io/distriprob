 ...
 *
 */
var UncheckedFactorial = /** @class */ (function () {
    function UncheckedFactorial() {
    }
    UncheckedFactorial.unchecked_factorial = function (i) {
        var factorials = [
            1,
            1,
            2,
    ...
    UncheckedFactorial.max_factorial = function () { return 170; };
    return UncheckedFactorial;
}());
exports.UncheckedFactorial = UncheckedFactorial;
