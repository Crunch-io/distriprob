...
var IGammaLarge = /** @class */ (function () {
    function IGammaLarge() {
    }
    IGammaLarge.igamma_temme_large = function (a, x) {
        var sigma = (x - a) / a;
        var phi = -Log1p.log1pmx(sigma);
        var y = a * phi;
        var z = Math.sqrt(2 * phi);
        if (x < a) {
            z = -z;
        }
        var workspace = [];
        ...
        var result = Rational.evaluate_polynomial(workspace, 1 / a);
...
exports.IGammaLarge = IGammaLarge;
