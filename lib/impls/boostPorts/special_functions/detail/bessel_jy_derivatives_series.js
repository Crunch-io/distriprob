...
var BesselJYDerivativesSeries = /** @class */ (function () {
    function BesselJYDerivativesSeries() {
    }
    BesselJYDerivativesSeries.bessel_j_derivative_small_z_series_term = function (v, x) {
        var N, term, mult, r;
     ...
     */
    BesselJYDerivativesSeries.bessel_j_derivative_small_z_series = function (v, x) {
        var prefix;
        ...
        var s = BesselJYDerivativesSeries.bessel_j_derivative_small_z_series_term(v, x);
        var max_iter = 500;
        var result = Series.sum_series(s, Precision.epsilon(), max_iter, 0).sum;
        return prefix * result;
    };
    BesselJYDerivativesSeries.bessel_y_derivative_small_z_series_term_a = function (v, x) {
        var N, mult, term, r;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    BesselJYDerivativesSeries.bessel_y_derivative_small_z_series_term_b = function (v, x) {
        var N, mult, term, r;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
     ...
     */
    BesselJYDerivativesSeries.bessel_y_derivative_small_z_series = function (v, x) {
        var prefix;
        var gam;
        var p = Math.log(x / 2);
        var scale = 1;
        ...
        var s = BesselJYDerivativesSeries.bessel_y_derivative_small_z_series_term_a(v, x);
        var max_iter = 500;
        var result = Series.sum_series(s, Precision.epsilon(), max_iter, 0).sum;
        result *= prefix;
        p = Math.pow(x / 2, v - 1) / 2;
        if (!need_logs) {
            ...
            var resultObj = Gamma.lgamma(-v);
            var sgn = resultObj.sign;
            prefix = resultObj.result + (v - 1) * Math.log(x / 2) - Constants.LN2();
            prefix = Math.exp(prefix) * sgn / Math.PI;
        }
        var s2 = BesselJYDerivativesSeries.bessel_y_derivative_small_z_series_term_b(v, x);
        max_iter = 500;
        var b = Series.sum_series(s2, Precision.epsilon(), max_iter, 0).sum;
        result += scale * prefix * b;
        return result;
    };
    return BesselJYDerivativesSeries;
}());
exports.BesselJYDerivativesSeries = BesselJYDerivativesSeries;
