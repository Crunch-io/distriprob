...
var DIGIT_AGREE_TOLERANCE_RISING = 13;
var DIGIT_AGREE_TOLERANCE_FALLING = 13;
var factorials = [
    1,
    1,
    2,
...
describe("factorial functions", function () {
            ...
            describe("boost data set", function () {
                var _loop_1 = function (i) {
                    it("should match high accuracy estimates of function values", function () {
                        var testValue = index_1.factorial.value(i);
                        var doa = digitCompare_1.digitsOfAgreement(factorials[i], testValue);
    ...
    describe("double", function () {
        describe("spot tests", function () {
            ...
            var _loop_2 = function (testCase) {
                it("should return " + testCase.result + " for factorial.double(" + testCase.n + ").", function () {
                    var testValue = index_1.factorial.double(testCase.n);
    ...
    describe("rising", function () {
        describe("spot tests", function () {
            ...
            var _loop_3 = function (testCase) {
                it("should return " + testCase.result + " for factorial.rising(" + testCase.x + ", " + testCase.n + ").", function () {
                    var testValue = index_1.factorial.rising(testCase.x, testCase.n);
    ...
    describe("falling", function () {
        function naive_falling_factorial(x, n) {
            if (n === 0) {
                return 1;
            }
            var result = x;
        ...
        describe("spot tests", function () {
            ...
            var _loop_4 = function (testCase) {
                it("should return " + testCase.result + " for factorial.falling(" + testCase.x + ", " + testCase.n + ").", function () {
                    var testValue = index_1.factorial.falling(testCase.x, testCase.n);
                    console.log("testVal:", testValue);
                    var doa = digitCompare_1.digitsOfAgreement(testCase.result, testValue);
